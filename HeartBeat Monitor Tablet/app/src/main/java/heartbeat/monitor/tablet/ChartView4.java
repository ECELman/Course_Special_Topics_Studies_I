...
public class ChartView4 extends View
{
    ...
    public ChartView4(Context context) 
    {	// TODO Auto-generated constructor stub
		super(context);           
	}
		
	//從外部使用此class 則必需使用此初始函式
	public ChartView4(Context context, AttributeSet attrs)
	{
		super(context, attrs);
		...
		X_Axis = (int) res.getDimension(R.dimen.Max_X_Axis) ;	//Default 460px	
		Y_Axis = (int) res.getDimension(R.dimen.Max_Y_Axis) ;	//Default 180px
