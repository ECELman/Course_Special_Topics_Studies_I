...
public class BluetoothService {
    ...
    public synchronized void setPatientId(int id) {
        Patient_Id = id;
    }    
    ...
    public synchronized void connected(BluetoothSocket socket, BluetoothDevice device) {
		...
		*/
        ...
        //為msg 貼上what的tag
        Message msg = mHandler.obtainMessage(Main.MESSAGE_DEVICE_CONNECTED); 
        
        Bundle bundle = new Bundle();
        bundle.putString(Main.DEVICE_NAME, device.getName());
        bundle.putString(Main.PATIENT_ID, String.valueOf(Patient_Id));
    ...
    private void connectionFailed() {
        ...
        Bundle bundle = new Bundle();
        bundle.putString(Main.TOAST, "無法連線到裝置");
        msg.setData(bundle);
        mHandler.sendMessage(msg);
    }
    ...
    private void connectionLost(BluetoothDevice device) {
        ...
        // Send a failure message back to the Activity
        Message msg = mHandler.obtainMessage(Main.MESSAGE_DEVICE_DISCONNECTED);
        Bundle bundle = new Bundle();
        bundle.putString(Main.DEVICE_NAME, device.getName());
        bundle.putString(Main.DEVICE_ADDRESS, device.getAddress());
        msg.setData(bundle);
    ...
    public void disconnect(String address) {
        ...
        ConnectedThread r;
        for(i=0; i<count; i++){
        	if(device_address[i].equals(address)){
        		r=thd[i];
        		r.cancel();
        ...
        msg.setData(bundle);
        mHandler.sendMessage(msg);*/
        /*Message msg = mHandler.obtainMessage(Monitor.MESSAGE_DISCONNECT);
        Bundle bundle = new Bundle();
        ...
        public void run() {
            ...
            while (true) {
                try {
                    ...
                    Message msg = mHandler.obtainMessage(Main.MESSAGE_ID);
                    Bundle bundle = new Bundle();
                    bundle.putString(Main.PATIENT_DATA, mmSocket.getRemoteDevice().getAddress());
                    msg.setData(bundle);
                    ...
                    mHandler.sendMessage(msg);
                    mHandler.obtainMessage(Main.MESSAGE_READ, bytes, -1, rcvData)
                    .sendToTarget();
